...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="bg-[#0B132B] text-white shrink-0 z-30 select-none shadow-sm">
      ...
      <div className="bg-white px-4 py-1.5 flex items-center justify-between overflow-x-auto no-scrollbar border-b border-slate-200 text-slate-700">
        <nav className="flex items-center space-x-1 py-0.5">
          ...
          {/* MORE DROPDOWN matching fin.png */}
          <div className="relative" ref={moreMenuRef}>
            ...
            {showMoreMenu && (
              <div className="absolute left-0 mt-1 w-48 bg-white rounded-xl shadow-lg border border-slate-200 py-1.5 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                <button
                  type="button"
                  onClick={() => {
